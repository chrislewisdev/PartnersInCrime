...
public class FieldOfView : MonoBehaviour {
	...
	public bool IsObjectInView(GameObject target)
	{
		...
		RaycastHit hitInfo;
		//Debug.DrawRay (transform.position, position - transform.position, Color.r);
		
		if (Physics.Raycast (lineOfSight, out hitInfo, (position - transform.position).magnitude, LayerMask.NameToLayer("Characters")))
		{
			return false;
		}
